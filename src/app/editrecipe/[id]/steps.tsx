...
const RecipeSteps:React.FC<{ updateRecipeData: UpdateRecipeDataType;recipedetails:ApiRecipeResponse|null }> = ({updateRecipeData}, recipedetails) =>{
  ...
  const [steps, setSteps] = useState<Step[]>(recipedetails.steps);
